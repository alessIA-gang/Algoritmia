...
int cima(const struct Pila & pilaTAD) {
    ...
    return pilaTAD.inicio->elemento.numero;
}

/* Push, añade un elemento a la parte superior de la pila */
void apilar(struct Pila & pilaTAD, int valor) {
    struct NodoPila *nuevo;
    nuevo = new NodoPila;
    nuevo->elemento.numero = valor;
...
int desapilar(struct Pila & pilaTAD) {
